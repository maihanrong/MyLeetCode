...
/*
 从大到小列举出每一位对应的取值情况存在数组里，遍历数组，s包含当前的字符就删掉，并且加上对于的数值
 */
func romanToInt(_ s: String) -> Int {
    ...
    var result = 0
    for i in arr {
        while tempS.hasPrefix(i.1) { // 判断s是否包含当前的字符
            result += i.0
            tempS.removeFirst(i.1.count)
        }
    }
    return result
}
...
/*
 官方思路：IV = V - I
 */
func romanToInt_2(_ s: String) -> Int {
